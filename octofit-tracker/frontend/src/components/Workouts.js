...
function Workouts() {
  ...
  const loadWorkouts = async () => {
    ...
    try {
      ...
      setError('Unable to load workouts data.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="card-body">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4">
            <div>
              ...
              <p className="text-muted mb-0">Browse workout records from the backend API in a polished Bootstrap table.</p>
            </div>
            <div className="mt-3 mt-md-0">
              <button type="button" className="btn btn-primary me-2" onClick={loadWorkouts} disabled={loading}>
          ...
          <form className="row g-3 mb-4">
            <div className="col-12 col-md-6">
              <label htmlFor="workoutsFilter" className="form-label">Search workouts</label>
              <input
                id="workoutsFilter"
                type="search"
